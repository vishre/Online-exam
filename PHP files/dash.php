...
<body style="background-color:#f7fafa">
<div class="header2">
<div class="top">
<h1 style="color:#12265c;font-family:candara;"><b>ADMIN</b> </h1>
<?php
...
<span class="title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php" class="log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log1"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}?>
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit(approx)</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
    ...
    $time = $row['time'];
	$eid = $row['eid'];
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$correct*$total.'</td><td>'.$time.'&nbsp;min</td></tr>';
}
echo '</table></div></div>';
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="time" name="time" placeholder="Enter time limit for test in minute(approx)" class="form-control input-md" min="1" type="number">
...
<div class="form-group">
  <label class="col-md-12 control-label" for="Time'.$i.' "></label>  
  <div class="col-md-12">
  <textarea rows="3" cols="5" name="Time'.$i.'" class="form-control" placeholder="Time limit for question number(in secs) '.$i.'"></textarea>  
  </div>
</div>
<!-- Text input-->
<div class="form-group">
